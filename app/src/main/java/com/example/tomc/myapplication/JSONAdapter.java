...
/**
 * Created by Kirisanth on 6/3/2015.
 */
public class JSONAdapter extends BaseAdapter {

    //URL used to download images
    private static final String IMAGE_URL_BASE = "http://covers.openlibrary.org/b/id/";

    //Used previously. It is the object used to let other objects know what is happening in your app
    Context mContext;
    //Used to imflate the view
    LayoutInflater mInflater;
    //Data source that will be coming from a server response
